...
class hybrid_department(osv.Model):
    ...
    _columns = {
        ...
        'member_ids': fields.one2many('res.users', 'department_id', 'Members', readonly=True),
...
class res_users(osv.osv):
    ...
    def create(self, cr, uid, data, context=None):
        ...
        employee_id = super(res_users, self).create(cr, uid, data, context=context)
...
#        return super(res_users, self).unlink(cr, uid, ids, context=context)
    ...
    def get_suggested_thread(self, cr, uid, removed_suggested_threads=None, context=None):
        ...
        if not user.display_employees_suggestions:
            ...
            return super(res_users, self).get_suggested_thread(cr, uid, removed_suggested_threads, context)
