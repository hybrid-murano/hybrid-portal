...
class hybrid_instance(osv.Model):
    ...
    _name = "hybrid.instance"
    _description = "Hybrid Instance"
    _columns = {
        'name': fields.char("Instance Name", required=True),
        'image': fields.char("Image Name", required=False),
        'address': fields.char("IP Address", required=True),
        'size': fields.char("Size", required=True),
        'az': fields.char("Availability Zone", required=True),
