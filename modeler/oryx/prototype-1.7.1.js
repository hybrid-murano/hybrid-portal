...
(function(GLOBAL) {
	function $(element) { return GLOBAL.$(element); }
...
//cyj			if ( elem.parentNode ) {
//cyj				elem.parentNode.selectedIndex;
//cyj			}
...
try {
	Array.prototype.slice.call( document.documentElement.childNodes, 0 ); //cyj	[0].nodeType;
...
//        return !(event instanceof window.Event);
  ...
  if (GLOBAL.Event) Object.extend(GLOBAL.Event, Event);
